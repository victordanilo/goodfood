...
export default {
  ...
  methods: {
    checkLogin () {
      ...
      if (this.$store.state.auth.isUserLoggedIn('company')) {
    ...
    loginJWT () {
      ...
      this.$store.dispatch('auth/loginJWT', payload)
        .then(() => {
          ...
          // Update roles
          this.$store.dispatch('loadUserRole', {aclChangeRole: this.$acl.change, userRole: 'company'})
